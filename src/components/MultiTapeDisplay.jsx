...
export default function MultiTapeDisplay({
  cintas = [[], []],
  cabezales = [0, 0],
  blankSymbol = "_",
}) {
  ...
  const labels = [
    "Cinta 1: Entrada / Escritura",
    "Cinta 2: Memoria / Conteo"
  ];
  ...
  return (
    ...
    >
      {cintas.map((cinta, tapeIdx) => {
        const cabezal = cabezales[tapeIdx] ?? 0;
        ...
        return (
          ...
          >
            ...
            >
              {labels[tapeIdx] || `Cinta ${tapeIdx + 1}`}
            </div>
